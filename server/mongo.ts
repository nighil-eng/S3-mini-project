...
export async function connectMongoDB(): Promise<boolean> {
  if (!MONGODB_URI) {
    console.log(
      'ℹ️ No MONGODB_URI found. Running with in-memory JSON database.'
    );
    return false;
  }
...
export const ElectricityBillModel =
  mongoose.models.ElectricityBill ||
  mongoose.model('ElectricityBill', ElectricityBillSchema);

export const ShoppingReceiptModel =
  mongoose.models.ShoppingReceipt ||
  mongoose.model('ShoppingReceipt', ShoppingReceiptSchema);

export const TripModel =
  mongoose.models.Trip ||
  mongoose.model('Trip', TripSchema);

export const FoodRecordModel =
  mongoose.models.FoodRecord ||
  mongoose.model('FoodRecord', FoodRecordSchema);

export const WasteRecordModel =
  mongoose.models.WasteRecord ||
  mongoose.model('WasteRecord', WasteRecordSchema);
